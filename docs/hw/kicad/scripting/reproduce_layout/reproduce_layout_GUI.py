...
###########################################################################
## Class reproduceLayoutGUI
###########################################################################

class reproduceLayoutGUI ( wx.Dialog ):

	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"reproduce layout", pos = wx.DefaultPosition, size = wx.Size( 313,492 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
		...
		self.chkbox_locked = wx.CheckBox( self, wx.ID_ANY, u"reproduce locked footprints", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer14.Add( self.chkbox_locked, 0, wx.ALL, 5 )

		self.chkbox_tracks = wx.CheckBox( self, wx.ID_ANY, u"reproduce tracks", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.chkbox_tracks.SetValue(True)
		bSizer14.Add( self.chkbox_tracks, 0, wx.ALL, 5 )

		self.chkbox_zones = wx.CheckBox( self, wx.ID_ANY, u"reproduce zones", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.chkbox_zones.SetValue(True)
		bSizer14.Add( self.chkbox_zones, 0, wx.ALL, 5 )

		self.chkbox_text = wx.CheckBox( self, wx.ID_ANY, u"reproduce text", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.chkbox_text.SetValue(True)
		bSizer14.Add( self.chkbox_text, 0, wx.ALL, 5 )

		self.chkbox_drawings = wx.CheckBox( self, wx.ID_ANY, u"reproduce drawings", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.chkbox_drawings.SetValue(True)
		bSizer14.Add( self.chkbox_drawings, 0, wx.ALL, 5 )

		self.chkbox_intersecting = wx.CheckBox( self, wx.ID_ANY, u"reproduce intersecting tracks/zones/drawings", wx.DefaultPosition, wx.DefaultSize, 0 )
