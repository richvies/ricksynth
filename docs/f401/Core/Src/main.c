...
static void MX_ADC1_Init(void)
{
  ...
  PA4   ------> ADC1_IN4
  */
  GPIO_InitStruct.Pin = Pots_Pin|AI_O1_Pin|AI_O2_Pin|AI_O3_Pin
                          |AI_O4_Pin;
...
static void MX_USART1_UART_Init(void)
{
  ...
  PA10   ------> USART1_RX
  */
  GPIO_InitStruct.Pin = Midi_TX__I_O5_Pin|Midi_I_O6_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(DAC_CS_GPIO_Port, DAC_CS_Pin);

  /**/
  LL_GPIO_ResetOutputPin(Shift_Reg_CS_GPIO_Port, Shift_Reg_CS_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOB, Flash_CS_Pin|Alt_CS_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = EAI_O1_Pin|EAI_O2_Pin|EAI_O3_Pin|EAI_O4_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = Shift_Reg_CS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(Shift_Reg_CS_GPIO_Port, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = Flash_CS_Pin|Alt_CS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
