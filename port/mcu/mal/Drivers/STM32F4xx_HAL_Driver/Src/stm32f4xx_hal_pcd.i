# 1 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
...
# 1 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
# 58 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
...
# 59 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c" 2
# 80 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
#define PCD_MIN(a,b) (((a) < (b)) ? (a) : (b))
#define PCD_MAX(a,b) (((a) > (b)) ? (a) : (b))
# 91 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_WriteEmptyTxFifo(PCD_HandleTypeDef *hpcd, uint32_t epnum);
static HAL_StatusTypeDef PCD_EP_OutXfrComplete_int(PCD_HandleTypeDef *hpcd, uint32_t epnum);
static HAL_StatusTypeDef PCD_EP_OutSetupPacket_int(PCD_HandleTypeDef *hpcd, uint32_t epnum);
# 123 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_Init(PCD_HandleTypeDef *hpcd)
{
  ...
  if (hpcd == 
# 129 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c" 3 4
             ((void *)0)
# 129 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
                 )
  {
    return HAL_ERROR;
  }
...
# 168 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
...
HAL_StatusTypeDef HAL_PCD_DeInit(PCD_HandleTypeDef *hpcd)
{
  ...
  if (hpcd == 
# 247 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c" 3 4
             ((void *)0)
# 247 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
                 )
  {
    return HAL_ERROR;
  }
...
# 270 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
...
# 1001 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_Start(PCD_HandleTypeDef *hpcd)
{
...
void HAL_PCD_IRQHandler(PCD_HandleTypeDef *hpcd)
{
  ...
  if (USB_GetMode(hpcd->Instance) == 0U)
  {
    ...
    if (((USB_ReadInterrupts((hpcd)->Instance) & ((0x1UL << (4U)))) == ((0x1UL << (4U)))))
    {
      ...
      ep = &hpcd->OUT_ep[temp & (0xFUL << (0U))];

      if (((temp & (0xFUL << (17U))) >> 17) == 2U)
      {
        if ((temp & (0x7FFUL << (4U))) != 0U)
        {
          (void)USB_ReadPacket(USBx, ep->xfer_buff,
                               (uint16_t)((temp & (0x7FFUL << (4U))) >> 4));

          ep->xfer_buff += (temp & (0x7FFUL << (4U))) >> 4;
          ep->xfer_count += (temp & (0x7FFUL << (4U))) >> 4;
        }
      }
      else if (((temp & (0xFUL << (17U))) >> 17) == 6U)
      {
...
# 1294 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
...
# 1469 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
...
# 1659 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_DevConnect(PCD_HandleTypeDef *hpcd)
{
  USB_OTG_GlobalTypeDef *USBx = hpcd->Instance;
...
# 1724 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Open(PCD_HandleTypeDef *hpcd, uint8_t ep_addr,
                                  uint16_t ep_mps, uint8_t ep_type)
{
...
# 1800 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
...
# 1848 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
...
# 2025 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
PCD_StateTypeDef HAL_PCD_GetState(PCD_HandleTypeDef *hpcd)
{
  return hpcd->State;
}
# 2049 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_WriteEmptyTxFifo(PCD_HandleTypeDef *hpcd, uint32_t epnum)
{
  USB_OTG_GlobalTypeDef *USBx = hpcd->Instance;
  uint32_t USBx_BASE = (uint32_t)USBx;
...
# 2109 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_EP_OutXfrComplete_int(PCD_HandleTypeDef *hpcd, uint32_t epnum)
{
  USB_OTG_GlobalTypeDef *USBx = hpcd->Instance;
  uint32_t USBx_BASE = (uint32_t)USBx;
...
# 2214 "../mal/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_EP_OutSetupPacket_int(PCD_HandleTypeDef *hpcd, uint32_t epnum)
{
  USB_OTG_GlobalTypeDef *USBx = hpcd->Instance;
  uint32_t USBx_BASE = (uint32_t)USBx;
